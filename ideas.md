Problem: Predict the price of the cheapest flight from NYC to Chicago with the following parameters:

Parameters that affect flight cost:
- Time until flight leaves
- Location of start
- Duration
